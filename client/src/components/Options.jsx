...
export function Options({ api }) {
  ...
  return (
    <div className="options-page">
      ...
      <p className="card-description">Add campsites and vehicles here. Assign one vehicle per campsite. People at a campsite use that campsite&apos;s vehicle.</p>
